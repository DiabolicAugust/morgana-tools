      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <header className="space-y-3">
          <p className="text-xs font-medium uppercase tracking-wide text-zinc-500 dark:text-zinc-400">
            <span>{TOOL_CATEGORY_LABELS[tool.categoryId]}</span>
            <span className="mx-2 opacity-60" aria-hidden="true">
              ·
            </span>
            <span title="Higher numbers reflect stronger relative keyword demand during your last tuning pass.">
              Search priority {tool.searchVolumePriority}
            </span>
          </p>
        ...
        <section aria-labelledby="long-desc-heading" className="space-y-3 text-base leading-relaxed text-zinc-700 dark:text-zinc-300">
        ...
        {related.length > 0 ? (
          <section aria-labelledby="related-tools" className="border-t border-zinc-200 pt-8 dark:border-zinc-800">
            <h2 id="related-tools" className="text-lg font-medium text-zinc-900 dark:text-zinc-100">
              Related tools
            </h2>
